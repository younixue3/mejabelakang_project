...
<main>
    <form class="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8" action="{{route('publication.update', $publication->id)}}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
