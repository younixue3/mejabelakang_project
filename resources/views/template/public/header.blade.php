        ...
        <div>
            <div
                ...
                <nav class="hidden md:flex space-x-10">
                    ...
                    <a href="{{ Route::is('home') ? '#publication' : '/' }}" id="nav4" class="text-base font-poppins font-medium py-5 {{ Route::is('about') ? 'border-b-4 border-white' : '' }} text-white hover:text-gray-200" onclick="navBar()">
                        Publication
                    </a>
