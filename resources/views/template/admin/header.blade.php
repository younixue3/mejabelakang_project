...
<body class="font-poppins" id="home">
    <div class="flex w-full h-full">
        <div id="mobile-menu" class="h-auto w-0 md:block md:w-80 duration-300 hover:w-80 bg-white rounded shadow-md z-10 static md:static overflow-hidden md:overflow-none">
            <div class="font-bold text-xl h-16 pl-5 pr-5 md:pr-0 overflow-hidden truncate flex">
                <img class="h-10 w-10 m-auto" src="https://tailwindui.com/img/logos/workflow-mark-indigo-500.svg"
                    alt="Workflow" /></span>
                <span class="ml-3.5 m-auto">
                    Meja Belakang
                </span>
            ...
            <div>
                <ul class="p-5 py-2">
                    ...
                    <a href="{{url('dashboard/gallery')}}">
                        <li
                            class="px-2.5 py-2 my-2.5 {{ Route::is('gallery') ? 'bg-gray-200' : 'bg-white hover:bg-gray-200' }} rounded-xl overflow-hidden truncate">
